  ...
  return (
    <div className="flex flex-col h-screen w-full overflow-hidden bg-[#f3f2f1]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside 
          className={cn(
            "bg-white border-l border-[#e1dfdd] flex flex-col transition-all duration-300 relative",
            isChatOpen ? "" : "w-12"
          )}
        ...
        >
          {isChatOpen && (
            <div 
              className="absolute left-0 top-0 bottom-0 w-1 hover:w-1.5 bg-transparent hover:bg-[#2E8B57] cursor-ew-resize transition-all group"
              onMouseDown={handleMouseDown}
            >
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-[#2E8B57] text-white rounded px-1 py-2 shadow-lg">
                <GripVerticalIcon className="w-3 h-3" />
              </div>
            </div>
          )}
          
          <div className="flex items-center justify-between p-3 border-b border-[#e1dfdd] h-12">
            {isChatOpen && <span className="font-bold text-sm flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-[#2E8B57] animate-pulse" /> AI Assistant</span>}
                ...
                <div className="space-y-4">
                  ...
                  {isPending && (
                    <div className="flex gap-1 p-3">
                      <span className="w-1.5 h-1.5 bg-[#2E8B57] rounded-full animate-bounce" />
                      <span className="w-1.5 h-1.5 bg-[#2E8B57] rounded-full animate-bounce [animation-delay:0.2s]" />
                      <span className="w-1.5 h-1.5 bg-[#2E8B57] rounded-full animate-bounce [animation-delay:0.4s]" />
                    </div>
                  )}
                </div>
              </ScrollArea>
              ...
              <div className="p-4 border-t border-[#e1dfdd]">
                ...
                >
                  <Input
                    ...
                    className="pr-10 py-5 text-xs bg-[#faf9f8] border-[#e1dfdd]"
                    disabled={!data.length}
                  />
                  <Button 
                    type="submit" 
                    size="icon" 
                    className="absolute right-1 w-8 h-8 bg-[#2E8B57] hover:bg-[#1e6f4f]"
