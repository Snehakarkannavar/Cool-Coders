...
export default function ReportsPage() {
  ...
  return (
    <div className="flex h-screen flex-col bg-[#f3f2f1]">
      ...
      <div className="h-12 bg-[#2c2c2c] flex items-center px-4 justify-between border-b border-[#1a1a1a]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-semibold text-sm">Reports</span>
        </div>
      </div>
